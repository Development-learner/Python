...
class FormulaCalculator:
    def __init__(self, master):
        ...
        self.insertmenu.add_command(label="Earth's Gravity Calculator", command=self.insertGravity)
        ...
        self.updatemenu.add_command(label="Check For Update :)", command=lambda: raise_frame(self.update))
        ...
        # Labels
        self.spTitleLabel = Label(self.update, text=" Update Will Be Coming In Feture. #MU").grid(row=1, column=0)

        self.spTitleLabel = Label(self.update, text="NO Update Today!").grid(row=0, column=0)
